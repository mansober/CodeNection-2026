...
export function CurrentPlanScreen({ period, onPeriod, onSchedule, onAssignments, filter, days, selectedDate, onDate, onTab, onAdd, onEdit, onAction, onImport }: MenuProps & { filter: PlanFilter; days: PlanDay[]; selectedDate: string; onDate: (date: string) => void; onTab: (tab: MainTab) => void; onAdd: () => void; onEdit: (item: Commitment) => void; onAction: (item: Commitment, action: string, date: string, duration: number, helper: string) => void; onImport: () => void }) {
